...
var commentSchema = new mongoose.Schema({
    ...
    mentioned_uid: [mongoose.Schema.Types.ObjectId] // List of uids mentioned in comment.
});

var tagSchema = new mongoose.Schema({
	x: Number, // tag x coord
	y: Number, // tag y coord
	width: Number, // tag width
	height: Number, // tag height
	uid: mongoose.Schema.Types.ObjectId, // tagged uid
	uname: String, // tagged name
	date_time: {type: Date, default: Date.now}, // tag date & time
	from_uid: mongoose.Schema.Types.ObjectId, // tag author id
	from_uname: String //tag author name
});
...
var photoSchema = new mongoose.Schema({
    ...
    likes_uid: [mongoose.Schema.Types.ObjectId], // List of user ids who like the photo.
    favorite_uid: [mongoose.Schema.Types.ObjectId], // List of user ids who add the photo to their favorite list.
    allowed_uid: [mongoose.Schema.Types.ObjectId], // List of user ids who can view the photo.
    comments: [commentSchema], // Array of comment objects representing the comments made on this photo.
    tagInfo: [tagSchema], // Array of tag objects representing the tags on this photo
});
